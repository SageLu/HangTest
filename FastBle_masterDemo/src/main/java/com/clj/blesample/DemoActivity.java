...
public class DemoActivity extends AppCompatActivity {
    ...
    private static final String DEVICE_NAME = "zz";                         // 符合连接规则的蓝牙设备名
    private static final String DEVICE_MAC = "android_c9938fc0-51f8-4c5d-8680-a82958914029";                        // 符合连接规则的蓝牙设备地址
